...
parser.add_argument('--bs', default='48')
...
# if model_name != 'cltr':
#     size = imsize
# elif model_name=='cltr' or model_name=='vit_plain':
#     size = 384
...
if args.resume:
    ...
    checkpoint = torch.load('./checkpoint_100/'+model_name+'/cltr_new_pretrained224-ckpt.pth')
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint_100/'+model_name+'/'+model_name+'_new_pretrained224-100-ckpt.pth')
#         torch.save(state, 'resnet50_pretrained32-ckpt.pth')
    ...
    print(content)
    with open(f'log_100/log_'+model_name+'_224/new_log_'+model_name+'_224_100.txt', 'a') as appender:
...
for epoch in range(start_epoch, args.n_epochs):
    ...
    # Write out csv..
    with open(f'log_100/log_'+model_name+'_224/new_log_'+model_name+'_224_100.csv', 'w') as f:
